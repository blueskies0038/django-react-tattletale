...
import { orderListUserTypes } from '../constants/order.constants'
...
export const logout = () => (dispatch) => {
    ...
    dispatch({ type: userLoginTypes.USER_LOGOUT })
    dispatch({ type: userDetailsTypes.USER_DETAILS_RESET })
    dispatch({ type: orderListUserTypes.ORDER_LIST_USER_RESET })
    dispatch({ type: userListTypes.USER_LIST_RESET })
}
...
export const updateUserProfile = (user) => async (dispatch, getState) => {
    try {
        dispatch({
            type: userUpdateProfileTypes.USER_UPDATE_PROFILE_REQUEST
        })
        ...
        dispatch({
            type: userUpdateProfileTypes.USER_UPDATE_PROFILE_SUCCESS,
            payload: data
        })
        ...
        dispatch({
            type: userUpdateProfileTypes.USER_UPDATE_PROFILE_FAIL,
            payload: error.response && error.response.data.detail
                ? error.response.data.detail : error.message,
        })
    }
